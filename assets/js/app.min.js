...
function _check_code() {
    ...
    fetch("https://gift.pokemontcgpocket.com/api/gift/post-support/", {
		...
		// 이 상태에서는 response.ok, response.json() 등 사용 불가!
		location.href = "https://gift.pokemontcgpocket.com/kr/get/"
	}).catch(error => {
		document.getElementById("error-msg").innerHTML =
			"<span>요청에 실패했습니다. https://gift.pokemontcgpocket.com/kr/ 에서 등록을 진행해 주세요</span>";
		console.error("https://gift.pokemontcgpocket.com/kr/ 에서 등록을 진행해 주세요", error);
	})
}
