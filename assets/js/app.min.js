...
function _check_code() {
    ...
    r.append("keyword", document.getElementById("input-keyword").value),
    fetch("/api/gift/post-support/", {
        method: "POST",
        body: r
        ...
        "ok" !== r.status)
            ...
            document.getElementById("input-keyword").classList.remove("input-error"),
...
$((function() {
    $("button#js-submit").prop("disabled", !0),
    $("#page-index input").on("change", (function() {
        "" !== $("input#input-support").val() && "" !== $("input#input-keyword").val() ? ($("input#input-keyword").val($("input#input-keyword").val().toUpperCase()),
        $("button#js-submit").prop("disabled", !1)) : $("button#js-submit").prop("disabled", !0)
    }
    ))
}
)),
